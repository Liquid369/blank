...
This issue tracker is only for technical issues related to Deviant Core.
General Deviant questions and/or support requests and are best directed to the [Deviant Discord](https://discord.dev.io).
...
### What version of Deviant Core are you using?
