...
RESOURCES += src/qt/rbx.qrc src/qt/rbx_locale.qrc

TRANSLATIONS += src/qt/locale/rbx_bg.ts \
                src/qt/locale/rbx_de.ts \
                src/qt/locale/rbx_en.ts \
                src/qt/locale/rbx_es.ts \
                src/qt/locale/rbx_fi.ts \
                src/qt/locale/rbx_fr.ts \
                src/qt/locale/rbx_it.ts \
                src/qt/locale/rbx_ja.ts \
                src/qt/locale/rbx_pl.ts \
                src/qt/locale/rbx_pt.ts \
                src/qt/locale/rbx_ru.ts \
                src/qt/locale/rbx_sk.ts \
                src/qt/locale/rbx_sv.ts \
                src/qt/locale/rbx_vi.ts \
                src/qt/locale/rbx_zh_CN.ts \
                src/qt/locale/rbx_zh_TW.ts
