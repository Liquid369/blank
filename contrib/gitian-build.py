...
def setup_repos():
    ...
    if not os.path.isdir('fls'):
        subprocess.check_call(['git', 'clone', 'https://github.com/Liquid369/fls.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/Liquid369/fls.git', help='Specify the URL of the repository. Default is %(default)s')
