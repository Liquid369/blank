Contributing to Rubus Core
============================

The Rubus Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/flitsnode/Rubus-core/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Rubus Core project, and is not to be
confused with overall Rubus Network Protocol consensus changes.

Whether a pull request is merged into Rubus Core rests with the project merge
...
Patches that change Rubus consensus rules are considerably more involved than
...
Where a patchset proposes to change the Rubus consensus, it must have been
...
The project leader is the release manager for each Rubus Core release.
