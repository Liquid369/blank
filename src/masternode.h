...
static const CAmount MN_COLL_AMT = 2500 * COIN;
...
//
// The Masternode Class. It contains the input of the 2500 RBX, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 2500 RBX - checking if valid masternode)
