...
void RegisterValidationInterface(CValidationInterface* pwalletIn)
{
    ...
    g_signals.m_internals->ChainTip.connect(boost::bind(&CValidationInterface::ChainTip, pwalletIn, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3));
...
void UnregisterValidationInterface(CValidationInterface* pwalletIn)
{
    ...
    g_signals.m_internals->ChainTip.disconnect(boost::bind(&CValidationInterface::ChainTip, pwalletIn, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3));
