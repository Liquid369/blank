...
# Copyright (c) 2019-2020 The BLANK Developers
...
from test_framework.fls_node import FlsTestNode
...
class FLS_ColdStakingTest(FlsTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(FlsTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 FLS from the pot)
