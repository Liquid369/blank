...
class ListReceivedTest (RbxTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 RBX.
        ...
        # Send 1 RBX to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 RBX sending them all (fee is 0.1 RBX)
        ...
        # Confirm transaction (2 RBX from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 RBX, send 0.6 RBX + 0.05 RBX fee
