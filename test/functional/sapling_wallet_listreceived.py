...
class ListReceivedTest (DeviantTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 DEV.
        ...
        # Send 1 DEV to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 DEV sending them all (fee is 0.1 DEV)
        ...
        # Confirm transaction (2 DEV from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 DEV, send 0.6 DEV + 0.05 DEV fee
