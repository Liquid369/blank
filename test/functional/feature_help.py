...
"""Verify that starting deviant with -h works as expected."""
import subprocess

from test_framework.test_framework import DeviantTestFramework
from test_framework.util import assert_equal

class HelpTest(DeviantTestFramework):
    ...
    def run_test(self):
        self.log.info("Start deviant with -? for help text")
        ...
        self.log.info("Start deviant with -version for version information")
