...
"""Verify that starting rbx with -h works as expected."""
import subprocess

from test_framework.test_framework import RbxTestFramework
from test_framework.util import assert_equal

class HelpTest(RbxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rbx with -? for help text")
        ...
        self.log.info("Start rbx with -version for version information")
