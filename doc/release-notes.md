DogeCash Core version v5.1.0 is now available from:  <https://github.com/dogecash/dogecash/releases>
...
- Windows `.zip` users need to manually copy the files from the `share/dogecash` folder to the `%APPDATA%\DOGECParams` directory.
...
Apple released it's last Mountain Lion update August 13, 2015, and officially ended support on [December 14, 2015](http://news.fnal.gov/2015/10/mac-os-x-mountain-lion-10-8-end-of-life-december-14/). DogeCash Core software starting with v5.2.0 will no longer run on MacOS versions prior to Sierra 10.12. Please do not report issues about MacOS versions prior to Sierra 10.12 to the issue tracker.
