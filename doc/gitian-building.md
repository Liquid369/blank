...
*Setup instructions for a gitian build of fls Core using a VM or physical system.*
...
to the fls GitHub release page.
...
- [Building fls Core](#building-fls-core)
...
You can also mail the files to Fuzzbawls (fuzzbawls@fls.org) and he will commit them.
