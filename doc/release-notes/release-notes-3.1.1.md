fls Core version *3.1.1* is now available from:  <https://github.com/fls-project/fls/releases>
...
fls Core v3.1.1 is a non-mandatory update to address bugs and introduce minor enhancements that do not require a network change.
