...
- [Development guidelines](#development-guidelines)
    - [General fls Core](#general-flits-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
fls Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
fls Core is a multi-threaded application, and deadlocks or other
...
([`valgrind.supp`](https://github.com/fls-project/fls/blob/master/contrib/valgrind.supp))
...
However, in open source software such as fls Core, where everyone uses
...
pay attention to for reviewers of fls Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: fls Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against fls Core so that they can be integrated
