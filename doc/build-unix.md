UNIX BUILD NOTES
====================
Some notes on how to build Rubus Core in Unix.

Note
---------------------
Always use absolute paths to configure and compile Rubus Core and the dependencies,
...
This will build rbx-qt as well, if the dependencies are met.
...
memory available when compiling Rubus Core. On systems with less, gcc can be
...
To build Rubus Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
If you want to build rbx-qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a rbx-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip rbxd" to strip the debug
...
Security
--------
To help make your Rubus Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, Rubus Core should be built with a non-executable stack
