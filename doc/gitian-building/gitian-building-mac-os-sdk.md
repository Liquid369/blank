...
The script [extract-osx-sdk.sh](https://github.com/flitsnode/Rubus-core/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
rbx/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/flitsnode/Rubus-core/blob/master/doc/README_osx.md) for troubleshooting tips.