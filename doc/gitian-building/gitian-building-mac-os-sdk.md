...
The script [extract-osx-sdk.sh](https://github.com/deviant/deviant/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
deviant/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/deviant/deviant/blob/master/doc/README_osx.md) for troubleshooting tips.