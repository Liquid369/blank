...
fls.conf           | contains configuration settings for flsd or fls-qt
flsd.pid           | stores the process id of flsd while running
...
debug.log           | contains debug information and general logging generated by flsd or fls-qt
