...
rbx.conf           | contains configuration settings for rbxd or rbx-qt
rbxd.pid           | stores the process id of rbxd while running
...
debug.log           | contains debug information and general logging generated by rbxd or rbx-qt
