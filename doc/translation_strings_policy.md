...
This document provides guidelines for internationalization of the Rubus Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Rubus network</source>
        <translation>
            <numerusform>%n active connection to Rubus network</numerusform>
            <numerusform>%n active connections to Rubus network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `rbx_en.ts` remains unchanged.
